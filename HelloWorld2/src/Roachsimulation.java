...
public class Roachsimulation {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "The inital roach population is  " + wholeFormat.format(bugs.getRoaches()));
		int cycle = 1;
		while (bugs.getRoaches() > 0) {
		    ...
		    bugs.spray(sprayPct);
		    JOptionPane.showMessageDialog(null, "The Roach population after cycle " + cycle + " " + pctFormat.format(sprayPct) +  " spaying is " + wholeFormat.format(bugs.getRoaches()));
		    cycle++;
		}
